...
internal class WishlistUpdatedEventHandler : INotificationHandler<WishlistUpdatedEvent>
{
  private readonly WishesContext _context;
  private readonly IWishlistRepository _wishlistRepository;

  public WishlistUpdatedEventHandler(WishesContext context, IWishlistRepository wishlistRepository)
  {
    _context = context;
    _wishlistRepository = wishlistRepository;
  }

  public async Task Handle(WishlistUpdatedEvent @event, CancellationToken cancellationToken)
  {
